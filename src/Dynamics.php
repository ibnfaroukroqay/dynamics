...
class Dynamics
{
    ...
    {
        $endPoint = DynamicsConstants::ENDPOINT_GET_ALL_SEGMENTS;
    ...
    {
        // todo
        // command : SyncOrdersOnDynamics
        $endpoint = DynamicsConstants::ENDPOINT_SYNC_ORDERS;

        return $this->sendRequest($endpoint, $data);
    }

    public function checkItemsOnHand($data)
    {
        // todo
        // command : CheckOnHandItemsOnDynamics
        $endpoint = DynamicsConstants::ENDPOINT_CHECK_ON_HAND_ITEMS;
    ...
    {
        // todo
        // DriverController@APIStore
    }

    public function checkOnHandsProducts()
    {
        // OrdersController
    }

    public function bulkOnHandItems()
    {
        // OrdersController
    }

    public function updateSalesWarehouse()
    {
        // command : SyncOrdersOnDynamics
    }
}
